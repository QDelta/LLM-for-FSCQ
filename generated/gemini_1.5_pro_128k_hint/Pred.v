...
unfold Proper, respectful, piff, pimpl. intros p q p' q' Hpq Hqp Hp'q' Hq'p'. intuition.
Qed.
...
unfold sep_star; rewrite sep_star_is; unfold sep_star_impl; intros; pred.
...
intros P Q HP m m' Hm.
subst; unfold lift_empty; firstorder.
Qed.
