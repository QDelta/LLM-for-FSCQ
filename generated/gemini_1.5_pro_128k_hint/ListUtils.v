...
induction la; destruct lb; simpl; intros; auto; inversion H; subst; constructor; auto.
apply H0. left; auto.
...
split; intros.
- apply NoDup_rev_1; assumption.
- apply NoDup_rev_2; assumption.
Qed.
...
induction a; destruct b; intros; auto; simpl in *; try discriminate.
rewrite combine_app.
rewrite IHa by congruence.
simpl. f_equal; auto.
(* No more tactics to try *)
Admitted.
...
intros; unfold incl in *; firstorder.
specialize (H a0 H1); destruct H; congruence.
Qed.
