...
intros T m m' m'' m''' vm hm p vm' hm' v Hsync1 Hstep Hsync2.
...
induction 1; eauto.
eexists; split; [constructor; eauto | simpl; eauto].
- inversion H.
...
inversion H; subst; eauto.
inversion H; subst; eauto.
(* The proof is by inversion on hypothesis H (step m vm hm p m' vm' hm' v). *)
inversion H; subst; try congruence; eauto.
