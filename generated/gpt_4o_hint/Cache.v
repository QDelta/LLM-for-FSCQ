...
unfold writeback; step; destruct (Map.find a (CSMap cs)) eqn:Hfind.
hoare.
hoare.
step.
...
intros. apply possible_crash_trans with m1; auto.
apply possible_crash_refl.
apply possible_crash_synced with (m := m) (m' := m1); auto.
(* No more tactics to try *)
Admitted.
