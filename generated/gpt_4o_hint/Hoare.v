...
intros pre1 pre2 Hpre p1 p2 Hp.
split; intros Hcorr done crash m vm hm out Hpre' Hexec;
eapply Hcorr; eauto; specialize (Hpre vm hm done crash); rewrite <- Hp; eauto.
