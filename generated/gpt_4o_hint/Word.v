...
f_equal; rewrite <- split2_iter; reflexivity.
Qed.
...
induction sz; simpl; intros; f_equal.
- reflexivity.
-
rewrite untimes2.
rewrite mult_assoc; rewrite (mult_comm k 2); rewrite <- mult_assoc; apply drop_mod2_add.
-
...
intros sz x; rewrite wmult_comm; apply wmult_unit_l.
Qed.
...
unfold goodSize; intros; eapply Nat.le_lt_trans; eauto using wordToNat_bound.
Qed.
...
Proof.
  ...
  - rewrite (shatter_word y), (shatter_word z). simpl.
    rewrite IHx. f_equal; apply andb_assoc.
Qed.
...
Proof.
  intros.
  unfold wxor, wnot.
  induction w; simpl; f_equal; auto with bool.
Qed.
