...
intros.
unfold updN.
destruct (Nat.eq_dec i a); subst; simpl; auto.
...
destruct (m1 x) eqn:Hm1, (m2 x) eqn:Hm2; auto.
Qed.
...
rewrite arrayN_split.
rewrite arrayN_split; simpl.
rewrite arrayN_split; simpl.
rewrite arrayN_split.
rewrite arrayN_isolate with (default := d).
rewrite arrayN_isolate with (default := d); simpl; auto.
rewrite arrayN_split.
rewrite arrayN_split.
