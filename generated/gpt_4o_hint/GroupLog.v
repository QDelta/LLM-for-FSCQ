...
unfold rep, would_recover_any; cancel.
apply pimpl_trans with (MLog.rep xp (MLog.Synced nr (fst (effective ds (length (MSTxns ms))))) (MSMLog ms) hm).
