...
intros; rewrite dsupd_iter_dsupd_tail.
rewrite <- combine_app_tail.
rewrite map_app_tail.
rewrite map_app_tail.
...
rewrite <- Nat.add_1_r.
rewrite Nat.add_1_r.
rewrite <- firstn_skipn with (l := data) (n := Datatypes.length data / valubytes * valubytes).
rewrite <- firstn_skipn with (l := data) at 1.
f_equal.
