...
unfold val2block, block2val, val2word, word2val; intros.
rewrite blocksz_ok; auto.
(* No more tactics to try *)
Admitted.
...
induction nr; simpl; intros; auto.
apply Forall_cons.
split.
apply setlen_length.
apply setlen_wellformed; auto.
apply IHnr; auto.
Qed.
...
induction nr; simpl; auto; intros.
apply Forall_cons.
apply setlen_length.
apply IHnr.
Qed.
...
intros; rewrite ipack_length in *; auto.
...
Proof.
(* original proof tokens: 34 *)
unfold selN_val2block, val2block; simpl.
(* No more tactics to try *)
Admitted.
