...
unfold synpred; intros; unfold sync_invariant; intros.
...
unfold sync_invariant, rep; intros.
...
eapply pimpl_exists_l; [ | eexists ]; intros; simpl.
(* No more tactics to try *)
Admitted.
...
unfold size_valid; intros; simpl; intuition; auto.
(* No more tactics to try *)
Admitted.
...
intros.
unfold mem_match, addr_valid in *.
intros a Ha.
specialize (H a).
...
unfold possible_sync, avs_match, mem_incl; intros.
destruct (In_dec addr_eq_dec a (map fst l)); try solve [apply avs2mem_none_notin; auto].
left; split; auto.
(* No more tactics to try *)
Admitted.
...
unfold synpred, cachepred, sync_xform; intros.
(* No more tactics to try *)
Admitted.
...
unfold synrep; unfold pimpl; intros.
(* No more tactics to try *)
Admitted.
...
unfold listpred, mem_pred_one, cachepred; simpl; intros.
eapply listpred_pimpl_replace; eauto.
(* No more tactics to try *)
Admitted.
...
unfold possible_crash, mem_match; intros.
split; intros; specialize (H a); destruct H; auto; try congruence.
destruct H; auto.
inversion H; subst.
destruct H; auto.
destruct H0; auto.
...
unfold sync_xform, cachepred, synpred; intros.
apply pimpl_exists_l; intros; destruct_lifts; simpl.
eapply pimpl_exists_l; intros; destruct_lifts; simpl.
eapply pimpl_exists_l; intros; destruct_lifts; simpl.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros; apply pimpl_exists_l; intros.
eapply pimpl_trans; [ apply cachepred_synpred | ].
eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros; eapply pimpl_exists_l; intros.
