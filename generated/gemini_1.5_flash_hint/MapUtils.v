...
split; intros; unfold Map.In; simpl.
(* No more tactics to try *)
Admitted.
...
destruct H; auto.
destruct H; auto; eapply subset_add_in_l; eauto.
apply SS.add_spec.
left; auto.
reflexivity.
apply subset_add.
...
split; intros; unfold SS.In; simpl.
