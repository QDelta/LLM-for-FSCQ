...
induction l; intros; inversion H; inversion H0; subst; auto.
eapply IHl; eauto.
(* No more tactics to try *)
Admitted.
...
contradict H2; unfold hashmap_get; destruct (weq h2 default_hash); simpl;
  try (destruct (weq h2 h2); intuition);
  try (rewrite upd_hashmap'_eq by auto; try congruence);
  intuition.
inversion H1; subst; clear H1.
inversion H0; subst; auto.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite hashmap_get_default; try congruence); intuition.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite hashmap_get_default; try congruence); intuition.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite hashmap_get_default; try congruence); intuition.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite hashmap_get_default; try congruence); intuition.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite upd_hashmap'_eq by auto; try congruence); intuition.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite hashmap_get_default; try congruence); intuition.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite hashmap_get_default; try congruence); intuition.
contradict H1; unfold hashmap_get; destruct (weq default_hash default_hash); simpl; try (destruct (weq default_hash default_hash); intuition); try (rewrite hashmap_get_default; try congruence); intuition.
(* Reached max number of model calls *)
...
induction l; intros; simpl in *; inversion H; subst; auto.
destruct H0; auto.
destruct H0; [|eapply IHl; eauto].
(* No more tactics to try *)
Admitted.
