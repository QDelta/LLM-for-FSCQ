...
intros. unfold recover_any. auto.
Qed.
...
unfold readOnly, readOnly in *; auto.
Qed.
...
unfold before_crash, after_crash, crash_xform; intros.
(* No more tactics to try *)
Admitted.
...
unfold recover_any, after_crash; intros.
rewrite crash_xform_exists_comm.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intro sm.
eapply pimpl_exists_l; [|eexists]; intros.
(* No more tactics to try *)
Admitted.
...
eapply split_or_one; [ | | ]; intros.
apply split_or_one; auto.
apply split_or_one; auto.
apply split_or_one; auto.
eapply split_or_one; try apply split_or_one; auto.
apply split_or_one; auto.
apply split_or_one; auto.
apply split_or_one; auto.
apply split_or_one.
...
unfold Proper, respectful; intros.
eapply pimpl_ext; try apply H0; auto.
eapply pimpl_ext; try apply H0; auto.
eapply pimpl_ext; try apply H0; auto.
unfold idempred; simpl; cancel.
unfold idempred; simpl; cancel.
unfold idempred; simpl; cancel.
auto.
(* No more tactics to try *)
...
Proof.
(* original proof tokens: 10 *)
unfold sep_star; rewrite sep_star_is; unfold sep_star_impl; unfold pimpl; intros.
