...
unfold map, list2byteset, selN'; simpl; auto.
intros.
induction l; simpl.
reflexivity.
simpl.
...
induction vs; intros; simpl; try lia.
inversion H.
(* No more tactics to try *)
Admitted.
...
destruct l; auto; try congruence.
...
unfold list_zero_pad; induction a; simpl; intros; auto.
rewrite IHa.
rewrite app_length. simpl. rewrite Nat.add_comm. lia.
Qed.
...
Proof.
(* original proof tokens: 83 *)
split; intros; inversion H; subst; auto.
