...
induction t1;
  ...
  inversion H0;
  subst;
  try (apply TCFile; auto);
  try (apply TCDir; auto);
  try (apply file_crash_trans; auto);
  eauto.
...
apply dirtree_ind2; simpl; intros.
apply dirtree_ind2; simpl; intros.
apply dirtree_ind2; simpl; intros.
apply dirtree_ind2; simpl; intros.
apply dirtree_ind2; simpl; intros.
...
apply dirtree_ind2; simpl; intros.
apply dirtree_ind2; simpl; intros.
apply dirtree_ind2; simpl; intros; eauto.
apply dirtree_ind2; simpl; intros; eauto.
(* No more tactics to try *)
Admitted.
...
destruct tree; destruct tree'; simpl; try solve [eauto using TCDir].
(* No more tactics to try *)
Admitted.
