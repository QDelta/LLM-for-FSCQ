...
unfold array_rep; simpl; intros.
unfold synced_array, rep_common, items_valid; simpl; split; intros; subst.
eapply pimpl_trans; [ apply emp_star_r | ].
intros.
eapply pimpl_trans; [apply emp_star_r |].
eapply pimpl_trans; [apply emp_star_r|].
eapply pimpl_trans; [ apply emp_star_r | ].
...
unfold sync_invariant, array_rep; intros.
(* No more tactics to try *)
Admitted.
...
unfold sync_invariant, avail_rep, pimpl; intros.
