...
unfold merge_bs; induction l; intros; simpl.
- reflexivity.
- destruct l'; simpl.
...
split; intros; unfold sep_star; rewrite sep_star_is; unfold sep_star_impl; intros; repeat deex; eexists; intuition eauto.
(* No more tactics to try *)
Admitted.
...
unfold dsupd_iter; simpl; intros; rewrite dsupd_iter_dsupd_tail; auto; simpl; try lia.
(* No more tactics to try *)
Admitted.
...
eapply treeseq_pred_tree_rep_latest; eauto.
Qed.
