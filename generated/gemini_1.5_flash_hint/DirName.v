...
unfold ascii2byte, byte2ascii; intros.
...
split; intros; unfold is_valid_wname.
(* No more tactics to try *)
Admitted.
...
Proof.
(* original proof tokens: 43 *)
unfold rep, DIR.rep, DIR.rep_macro; eexists; intuition.
eapply DIR.bfile0_empty.
inversion H; subst.
eauto.
simpl; auto.
simpl; auto.
intros; unfold mem_atrans; intros.
inversion H0; subst.
eauto.
inversion H; auto.
(* No more tactics to try *)
