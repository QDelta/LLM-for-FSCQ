...
unfold replay_disk; induction l; simpl; intros.
auto.
rewrite IHl.
rewrite length_updN.
reflexivity.
...
unfold replay_disk, updN; simpl; intros.
induction (Map.elements ds); simpl; intros; try reflexivity.
(* No more tactics to try *)
Admitted.
...
unfold replay_disk, vssync; simpl; intros.
...
intros. unfold map_valid. intros.
split; auto.
eapply H; eauto.
apply map_valid_Forall_fst_synced in H0; auto.
apply map_valid_Forall_fst_synced in H; auto.
(* No more tactics to try *)
Admitted.
...
unfold log_valid; intros.
apply conj.
apply KNoDup_filter; auto.
destruct H.
(* No more tactics to try *)
Admitted.
...
unfold vsupd_vecs, replay_disk; intros.
(* No more tactics to try *)
Admitted.
...
intros. unfold disjoint, overlap; simpl; intros.
apply conj.
intros.
unfold disjoint, overlap in H; simpl in H; intuition.
apply in_map_fst_exists_snd in H1; try congruence.
(* No more tactics to try *)
Admitted.
