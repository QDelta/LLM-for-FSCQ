...
split; [apply stars_prepend | apply stars_prepend; apply sep_star_comm ].
Qed.
...
intros.
destruct_lift H0.
eapply listmatch_length_r in H0; eauto.
split; auto.
rewrite H; auto.
rewrite combine_length_eq in H0; auto.
(* No more tactics to try *)
Admitted.
...
Proof.
(* original proof tokens: 28 *)
unfold indrep_n_helper; intros; split; intros; destruct addr_eq_dec; subst; try congruence; auto.
eapply pimpl_sep_star; [eapply pimpl_refl|]; auto.
(* No more tactics to try *)
Admitted.
...
split; unfold piff; intros; unfold listpred.
(* No more tactics to try *)
Admitted.
...
split; intros; unfold indrep in *; destruct_lifts.
apply piff_comm.
split; intros; repeat (eexists; split); try apply piff_refl; try apply upd_irec_get_ind; try apply upd_irec_get_dind; try apply upd_irec_get_tind; try apply upd_irec_get_blk; try apply upd_irec_get_iattr; auto.
apply piff_comm.
split; intros; repeat (eexists; split); try apply piff_refl; try apply upd_irec_get_ind; try apply upd_irec_get_dind; try apply upd_irec_get_tind; try apply upd_irec_get_blk; try apply upd_irec_get_iattr; auto.
(* No more tactics to try *)
Admitted.
