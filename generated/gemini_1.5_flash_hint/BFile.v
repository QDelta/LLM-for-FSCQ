...
unfold ilist_safe; intros; split; auto.
apply incl_refl.
Qed.
...
unfold smrep_single; simpl; intros.
(* No more tactics to try *)
Admitted.
...
Proof.
(* original proof tokens: 48 *)
unfold smrep_single_helper, put_dirty, smrep_single.
(* No more tactics to try *)
Admitted.
...
unfold file_crash; intuition.
destruct H; subst; auto.
destruct H; subst; auto.
unfold possible_crash_list; simpl; split; auto.
...
unfold file_match, crash_xform; simpl; intros; apply pimpl_exists_l; intros.
...
unfold smrep; simpl; intros; destruct_lifts.
...
Proof.
(* original proof tokens: 76 *)
unfold flist_crash, clear_caches; intros.
(* No more tactics to try *)
Admitted.
