...
intros A B PA PB f f' H.
split.
intros x PX.
apply H in PX.
destruct PX as [PY QX].
split.
exact PY.
exact QX.
intros y PY.
apply H in PY.
destruct PY as [QX QY].
split.
exact QX.
exact QY.
Qed.
...
intros a H AP1a.
apply notindomain_not_indomain; unfold not; intro.
apply notindomain_not_indomain in AP1a; auto.
(* No more tactics to try *)
Admitted.
