...
do 2 (intros; simpl in *); intros; subst; constructor; auto.
(* No more tactics to try *)
Admitted.
...
unfold sync in *; 
  repeat (match goal with
    | [ |- _ =p=> _ ] => 
      eapply pimpl_trans; [try apply (fun _ _ _ => sync_xform) | ]
    | [ |- _ =p=> _ ] => 
      eapply pimpl_trans; [apply mem_pred_pimpl; reflexivity | ]
  end).
(* No more tactics to try *)
Admitted.
...
eapply pimpl_trans.
eapply pimpl_trans; [apply pimpl_exists_l; intro |].
