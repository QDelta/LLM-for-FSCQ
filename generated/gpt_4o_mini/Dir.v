...
unfold items_per_val; unfold itemtype.
...
Proof. intros H. (* Introduce the hypothesis for the proof. *)
    rewrite bit2bool_0 in H. (* Use the previously defined fact.*)
    discriminate H. (* Conclude that this leads to a contradiction. *)
Qed.
...
intros l i dmap name inum isdir Hnotdom Hvalid Hpred Hlen Hneq Hgood.
