...
intros fsxp inum off v mscs T rx.
unfold diskset_pred.
...
unfold recover.
unfold find_subtree, find_dirlist, update_subtree.
(* Here is the next tactic to use *)
intros; unfold find_subtree in *.
(* No more tactics to try *)
Admitted.
