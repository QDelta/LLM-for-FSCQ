...
apply listmatch_combine_l_length.
Qed.
...
intros F F' indlvl Fs bxp ir fsl l1 l2 m Hlen Hpred.
unfold indrep_n_helper in Hpred.
unfold listmatch in Hpred.
rewrite <- Hlen in Hpred.
(* No more tactics to try *)
Admitted.
...
Proof.
(* original proof tokens: 33 *)
intros Fm Fm' off indlvl bxp Fs bn iblocks l_part fsl m Hlen Hfsl.
...
eapply pimpl_apply; [| idtac].
eapply pimpl_apply; [ idtac | ].
apply pimpl_refl.
eapply restart_canceling.
eapply pimpl_apply; [ | apply pimpl_refl].
eapply pimpl_apply; [| apply pimpl_refl].
eapply pimpl_apply; [ | idtac ].
apply sep_star_lift_l; auto.
intros. 
eapply pimpl_refl.
