...
try (f_equal; auto; eapply replay_seq_latest_length; eauto).
apply replay_seq_latest_length in H0.
(* No more tactics to try *)
Admitted.
...
eapply pimpl_exists_l; intros; subst; repeat (eexists; split).
eapply pimpl_exists_l; intros; subst; repeat (eexists; split).
eapply pimpl_trans; [apply pimpl_exists_l; intros; subst; eapply pimpl_trans |].
apply flatten_default.
eapply pimpl_exists_l; intros; subst; eapply pimpl_trans.
apply pimpl_exists_l; intros; subst; eapply pimpl_trans.
apply pimpl_exists_l; intros; subst; apply flatten_default.
apply pimpl_refl.
(* Reached max number of model calls *)
Admitted.
