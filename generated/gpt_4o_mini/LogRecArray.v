...
intros xp items len a v Hvalid Hwf.
(* No more tactics to try *)
Admitted.
...
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
eapply pimpl_trans; [ apply crash_xform_exists_comm | ].
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
...
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
intros; apply pimpl_exists_l; intros.
apply pimpl_exists_l; intros.
apply pimpl_exists_l; intros.
apply pimpl_exists_l; intros.
apply pimpl_exists_l; intros.
...
intros; unfold sync_invariant in *; 
repeat match goal with 
| [ H : exists F, _ |- _ ] => destruct H as [F H]
| [ H : forall P, _ |- _ ] => apply H
| [ |- exists F, _ ] => eexists
end.
(* No more tactics to try *)
Admitted.
...
autorewrite with core; simpl in *; intuition.
eapply exists_one; intros.
apply sep_star_lift_l.
eapply exists_one; intros.
apply exists_one; intros; simpl; auto.
eapply pimpl_exists_l.
eapply pimpl_exists_l.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
...
intros; 
  repeat match goal with
  | [ |- context[crash_xform ?x] ] => unfold crash_xform; set_evars; simpl in *
  | [ |- ( ?p * ?q =p=> ?r) ] => unfold stars in *; simpl in *
  end; 
