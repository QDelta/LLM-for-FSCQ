...
split; intros; unfold smrep_single_helper; simpl;
match goal with
| [ |- context[match Map.find ?k ?m with Some _ => _ | None => _ end] ] => destruct (Map.find k m) eqn:?
end;
unfold smrep_single; simpl; cancel.
cancel.
destruct (Map.find st dblocks) eqn:?; try congruence.
cancel.
destruct (Map.find st (Map.remove inum dblocks)) eqn:?; try congruence.
cancel.
destruct (Map.find st dblocks); cancel.
destruct (Map.find st (Map.remove inum dblocks)); cancel.
destruct (Map.find st dblocks); cancel.
destruct (Map.find st (Map.remove inum dblocks)); cancel.
cancel.
clear t1 t2.
destruct (Map.find st dblocks) eqn:?; cancel.
destruct (Map.find st (Map.remove inum dblocks)); cancel.
destruct (Map.find st dblocks); cancel.
destruct (Map.find st (Map.remove inum dblocks)); cancel.
destruct (Map.find st dblocks); cancel.
...
destruct (Map.find st dblocks) eqn:?; cancel.
destruct (Map.find st dblocks) eqn:?; cancel.
destruct (Map.find st (Map.remove inum dblocks)) eqn:?; cancel.
destruct (Map.find st (Map.remove inum dblocks)) eqn:?; cancel.
destruct (Map.find st dblocks) eqn:?; cancel.
destruct (Map.find st (Map.remove inum dblocks)) eqn:?; cancel.
destruct (Map.find st dblocks) eqn:?; cancel.
