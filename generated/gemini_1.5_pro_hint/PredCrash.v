...
unfold ptsto_subset.
intros.
unfold ptsto, exis in *.
intuition.
eexists; eauto.
unfold ptsto_subset in H.
pred.
(* No more tactics to try *)
Admitted.
...
split; unfold piff, sync_xform, lift_empty; intros.
intros; repeat deex; intuition.
split; intros; repeat deex; intuition.
unfold sync_mem in *; intuition.
(* No more tactics to try *)
Admitted.
