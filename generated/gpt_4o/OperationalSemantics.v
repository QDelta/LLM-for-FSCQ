...
intros until v; intros Hsync_before Hstep Hsync_after; inversion Hstep; subst; eauto.
exists m.
split; auto.
...
induction 1.
eexists (Finished m vm hm v); split; eauto.
eexists (Finished m vm hm tt); split; eauto.
eexists (Finished m vm hm tt); split; [constructor|reflexivity].
eexists (Finished m vm hm t). split; [constructor | reflexivity].
eexists (Finished m' vm' hm' v); split; [econstructor; eauto; reflexivity | eauto].
(* No more tactics to try *)
Admitted.
