...
unfold sm_vs_valid; intros; rewrite length_updN in *; intuition.
apply H in H0; destruct H0 as [H0 _]; contradiction.
apply vs_synced_updN_synced.
...
unfold sm_sync_invariant, piff; split; intros; [apply H | apply H].
apply H0; apply H.
(* No more tactics to try *)
Admitted.
...
unfold mem_except_mem, mem_union; intros.
extensionality a.
destruct (ex a) eqn: Heq; destruct (m a) eqn: Heqm; simpl; auto.
Qed.
