...
unfold list2nmem, list2nmem_fix; 
intros; apply functional_extensionality; intros; 
induction l; simpl; auto.
repeat (match goal with
| [ H : _ |- _ ] => rewrite H; clear H
| [ |- context[match ?x with | 0 => _ | S _ => _ end] ] => destruct x; simpl
| [ |- context[if Nat.eq_dec ?x 0 then _ else _] ] => destruct (Nat.eq_dec x 0); simpl
end).
apply f_equal.
(* No more tactics to try *)
Admitted.
...
intros T V vs def i pts H.
unfold arrayN_ex.
rewrite arrayN_isolate; auto.
eapply (@listpred_isolate) in H; eauto.
(* No more tactics to try *)
Admitted.
