...
unfold rep, intact; simpl.
intros.
unfold rep, rep_inner in *.
cancel.
(* No more tactics to try *)
Admitted.
...
intros; unfold rep, recover_any; cancel.
(* No more tactics to try *)
Admitted.
...
eapply pimpl_trans; [| apply pimpl_exists_l; intros; cancel].
apply pimpl_exists_l; intro.
eapply pimpl_trans; [| eapply pimpl_exists_l; intros; cancel].
apply pimpl_exists_l; intro.
...
destruct st; simpl in *; cancel.
apply GLog.rep_hashmap_subset; auto.
apply GLog.rep_hashmap_subset; auto.
(* No more tactics to try *)
Admitted.
...
set_evars; unfold rep_inner; simpl; intros; eauto.
...
unfold before_crash, after_crash; intros.
xform_norm.
cancel.
xform_norm. 
cancel. 
...
unfold after_crash; intros; xform_norm; cancel.
(* No more tactics to try *)
Admitted.
...
rewrite H0.
eapply pimpl_trans; [apply pimpl_exists_r; intuition | ].
eapply pimpl_exists_l; intros.
apply pimpl_exists_l; intros.
apply pimpl_exists_r; intros.
eapply pimpl_exists_l; intros.
eapply pimpl_refl.
eapply pimpl_exists_l; intros.
apply pimpl_exists_l; intros.
...
unfold idempred.
repeat (eapply pimpl_trans; [| eauto]).
(* No more tactics to try *)
Admitted.
...
unfold crash_xform, intact; intros.
xform_norm.
...
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros n.
(* Reached max number of model calls *)
Admitted.
