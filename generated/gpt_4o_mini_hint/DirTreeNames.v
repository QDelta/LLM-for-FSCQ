...
apply Forall_map.
apply Forall_map.
apply Forall_map. apply Forall_map. apply Forall_map.
apply Forall_map. apply Forall_map. apply Forall_map. apply Forall_map. apply Forall_map. apply Forall_map.
...
intros p1 p2 tree subtree Htd Hnp2 Hnp1.
...
intros.
 unfold update_subtree in *.
 destruct base; simpl in *; auto.
 destruct t; simpl in *; try congruence.
 assert (exists suffix, pn = suffix) as [suffix Hsuffix].
 { destruct H1. eauto. }
