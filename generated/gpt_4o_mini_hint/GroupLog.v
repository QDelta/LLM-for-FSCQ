...
unfold readOnly, MSLL; intros; destruct ms as [m1 t1], ms' as [m2 t2]; simpl in *; intuition.
...
intros ds ts xp HReplay HValid.
induction HReplay; simpl; auto.
destruct ds; simpl in *; auto.
(* No more tactics to try *)
Admitted.
...
unfold vmap_match; intros; subst; auto.
(* No more tactics to try *)
Admitted.
...
intuition.  
apply Forall_forall.
intros x Hx2 x0 Hx1 x1 Hx0 x2 Hx d d' ts Hts Hlen.
eapply Forall_forall; intros.
autorewrite with lists.
intuition.
...
apply Forall_forall; intros.
erewrite Forall_forall in Hlen; eauto.
(* No more tactics to try *)
Admitted.
...
unfold dset_match, would_recover_any.
intros; cancel.
rewrite cached_recover_any; try eapply H1; auto.
(* No more tactics to try *)
Admitted.
