...
unfold rep, would_recover_before; intros.
cancel; auto.
pose proof (H1).
...
Proof.
(* original proof tokens: 17 *)
unfold rep, would_recover_either; intros.
cancel.
eapply pimpl_or_r; right.
eapply pimpl_trans; try apply stars_app; try assumption.
(* No more tactics to try *)
Admitted.
...
Proof.
(* original proof tokens: 17 *)
unfold equal_unless_in; split; intros; destruct H; split; auto.
(* No more tactics to try *)
Admitted.
...
intros. unfold equal_unless_in. split; auto. Qed.
...
cancel.
unfold would_recover_either, recover_either_pred; cancel.
(* No more tactics to try *)
Admitted.
...
Proof.
(* original proof tokens: 40 *)
unfold rep, recover_either_pred; intros.
xform_norm; cancel.
(* No more tactics to try *)
Admitted.
