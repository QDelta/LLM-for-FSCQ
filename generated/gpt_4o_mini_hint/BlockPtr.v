...
unfold indrep, IndRec.items_valid; intros.
split; autorewrite with core; eauto.
(* No more tactics to try *)
Admitted.
...
destruct_lift H.
auto.
unfold indrep in *; destruct_lifts; auto.
apply indrep_n_tree_sm_sync_invariant in H.
(* No more tactics to try *)
Admitted.
