...
destruct vs; simpl; f_equal; auto.
(* No more tactics to try *)
Admitted.
...
Proof.
(* original proof tokens: 36 *)
(* generated proof tokens: 75 *)
intros p p' Hp ds ds' Hds Hpd.
unfold diskset_pred in *; subst; eauto.
unfold d_in in *; intros; destruct H; subst; auto.
apply Hp. apply Hpd. simpl. left. reflexivity.
apply Hp. apply Hpd. simpl. right. apply H.
Qed.
