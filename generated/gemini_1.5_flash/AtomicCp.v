...
Proof.
(* original proof tokens: 43 *)
destruct t; simpl; auto; try congruence.
(* No more tactics to try *)
Admitted.
...
eauto.
intros.
destruct (find_subtree [] (TreeFile inum f)); simpl; try congruence.
eauto.
exists nil.
destruct (find_subtree [] (TreeFile inum f)); simpl; try congruence.
destruct (find_subtree [] (TreeFile inum f)); simpl; try congruence.
...
intros.
apply flatmem_crash_xform_or_dist; auto.
(* No more tactics to try *)
Admitted.
...
destruct tree; simpl; auto; try (intros; destruct H; subst; auto).
(* No more tactics to try *)
Admitted.
...
destruct tree; simpl; auto; intros.
destruct H; auto.
(* No more tactics to try *)
Admitted.
