...
(* generated proof tokens: 831 *)
simpl.
intros.
unfold find_dirlist.
destruct (string_dec name name) eqn:Heq; subst.
  simpl.
  inversion H0; subst.
  auto.
  simpl in H0.
...
inversion H0; subst.
inversion H0; subst.
inversion H0; subst; auto; try congruence.
Qed.
...
simpl; intros; destruct (string_dec name name); simpl; auto.
apply find_dirlist_find_subtree_helper; auto; try congruence.
Qed.
...
intros.
eapply find_subtree_helper1; eauto.
eapply find_subtree_helper1; eauto.
(* No more tactics to try *)
Admitted.
...
intros.
destruct (pathname_decide_prefix [a] pn) as [Hprefix|Hnoprefix].
inversion Hprefix.
...
intros.
destruct (find_subtree (name :: rest) (TreeDir n (delete_from_list name l))) eqn:H1.
inversion H1; auto.
inversion H1; auto.
inversion H1; auto.
inversion H1; auto.
...
(* original proof tokens: 21 *)
intros.
destruct (find_subtree (name :: rest) (delete_from_dir name (TreeDir n l))) eqn:E.
inversion E; auto.
...
intros.
apply find_subtree_update_subtree_oob.
(* No more tactics to try *)
Admitted.
