...
eapply start_normalizing_left; [|eauto].
flatten.
eapply pimpl_exists_l; intros.
eapply pimpl_trans; [ | apply flatten_default ].
eapply pimpl_trans; [apply flatten_default |].
eapply pimpl_trans; [| eapply flatten_default ].
eapply start_normalizing_left; [apply flatten_default|];eauto.
eapply pimpl_trans; [apply flatten_default |].
eapply start_normalizing_left; [apply flatten_default |];eauto.
...
destruct start; simpl; auto.
rewrite IHl; auto.
eauto.
destruct a0; simpl; try congruence.
auto.
(* No more tactics to try *)
Admitted.
...
eapply sep_star_lift_apply; eauto; try congruence.
(* No more tactics to try *)
Admitted.
...
eapply pred_except_ptsto_pimpl; eauto.
eapply pred_except_ptsto_pimpl; eauto.
