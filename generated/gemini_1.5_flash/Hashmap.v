...
unfold hashmap_get, default_hash.
destruct hm; simpl; auto;
unfold hashmap_get, default_hash;
destruct (weq (hash_fwd default_valu) (hash_fwd default_valu)); auto.
(* No more tactics to try *)
Admitted.
...
intros.
inversion H0; subst; clear H0; inversion H; subst; clear H; auto.
inversion H2; subst; clear H2; auto.
inversion H0; subst; clear H0; inversion H2; subst; clear H2; auto.
inversion H1; subst; clear H1; auto.
contradict H2; auto.
contradict H0; auto.
inversion H0; subst; clear H0.
contradict H1; auto.
destruct (weq h2 default_hash); simpl; auto.
