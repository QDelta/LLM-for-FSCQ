...
reflexivity.
destruct a; simpl.
destruct (string_dec s n1); destruct (string_dec s n2); simpl; try rewrite IHt; auto.
congruence.
Qed.
...
Proof.
(* original proof tokens: 479 *)
induction ft; simpl; intros; auto.
(* No more tactics to try *)
Admitted.
...
induction ft; simpl; auto; intros.
constructor; auto.
(* No more tactics to try *)
Admitted.
...
induction n; simpl.
- intros; auto.
- intros; simpl in *; rewrite IHn; auto.
Qed.
...
destruct ft; simpl; auto; try (cbn; constructor; auto).
(* No more tactics to try *)
Admitted.
...
destruct t; simpl; try solve [auto].
Qed.
