...
induction nbytes; simpl; auto; try lia.
destruct s; simpl; auto; rewrite IHnbytes; lia.
Qed.
...
induction n; auto; simpl; constructor; auto.
Qed.
...
induction s; simpl; auto.
destruct (ascii_dec a zero); simpl; auto; lia.
Qed.
...
(* generated proof tokens: 52 *)
apply CondBijective; auto.
intros.
eapply cond_left_inv_inj; eauto.
eapply dirname_cond_inverse.
intros.
...
split; intros; subst; auto; try congruence.
(* No more tactics to try *)
Admitted.
...
induction s; simpl; auto; split; intros; try congruence.
apply ZeroEmpty.
...
inversion H; subst.
inversion H; subst.
destruct (ascii_dec a zero); subst; auto; try congruence.
apply ZeroCons; auto.
inversion H; auto.
inversion H; auto.
inversion H; auto.
...
destruct s; constructor; auto; try lia.
apply SNameValid; auto; try lia.
constructor.
constructor.
constructor.
constructor.
...
intros.
eapply listpred_pimpl_replace; try apply readdir_trans_addr_ok; auto.
(* No more tactics to try *)
Admitted.
