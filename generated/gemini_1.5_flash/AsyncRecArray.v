...
unfold array_rep.
apply iff_refl; split; [idtac | idtac]; intros.
(* No more tactics to try *)
Admitted.
...
eapply pimpl_exists_l; auto.
eapply pimpl_exists_l; auto.
eexists.
eapply pimpl_exists_l; [intro|].
eapply pimpl_exists_l; intro.
eapply pimpl_exists_l; auto.
eapply pimpl_exists_l; clear H; intros x; eapply pimpl_exists_l; clear H0; intros x0; eapply pimpl_exists_l; clear H1; intros x1.
eexists.
eapply pimpl_exists_l; [intro|].
eapply pimpl_exists_l; intro.
...
Proof.
(* original proof tokens: 52 *)
intros; simpl in H; destruct st; simpl in H; try lia.
(* No more tactics to try *)
Admitted.
...
eapply pimpl_exists_l; eexists; eauto.
(* No more tactics to try *)
Admitted.
