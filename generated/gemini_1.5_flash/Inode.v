...
eapply pimpl_and_dup; simpl; autorewrite with core; eauto.
eapply pimpl_and_dup; simpl.
apply pimpl_and_dup.
apply pimpl_and_dup.
eapply pimpl_and_dup; simpl.
(* No more tactics to try *)
...
eapply SepAuto.start_normalizing_left; [ | eapply SepAuto.flatten_default | ].
eapply pimpl_exists_l; intros; eauto.
eapply SepAuto.start_normalizing_left; [| eapply SepAuto.flatten_default | ].
eapply SepAuto.start_normalizing_right; [| apply piff_refl | ].
eapply SepAuto.start_normalizing_right; [| eapply SepAuto.flatten_default | ].
eapply SepAuto.start_normalizing_right; [| apply piff_refl | ].
eapply SepAuto.start_normalizing_right; [ | apply piff_refl | ].
eapply SepAuto.start_normalizing_right; [| apply piff_refl | ].
eapply SepAuto.start_normalizing_left; [| eapply SepAuto.flatten_default | ].
...
eapply SepAuto.start_normalizing_left; [| eapply SepAuto.start_normalizing_right | ].
(* No more tactics to try *)
Admitted.
...
split; auto; try apply sm_sync_invariant_piff.
(* No more tactics to try *)
Admitted.
