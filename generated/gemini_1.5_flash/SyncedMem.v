...
split; unfold sm_ds_valid; unfold sm_vs_valid; unfold pushd; try solve [auto].
intros.
eapply Forall_cons.
...
intros. unfold sm_vs_valid. intros. unfold sm_unsynced. simpl. split; auto.
discriminate.
simpl.
auto.
discriminate.
...
intros.
apply IHa.
apply sm_vs_valid_upd_unsynced; auto.
Qed.
...
simpl.
extensionality a.
destruct (m1 a); destruct (m2 a); simpl; auto.
Qed.
...
Proof.
(* original proof tokens: 29 *)
intros. unfold mem_except_mem. unfold mem_disjoint. intros.
(* No more tactics to try *)
Admitted.
