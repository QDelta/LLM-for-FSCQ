...
intros.
eapply map_valid_vssync_vecs; eauto.
eapply map_valid_vsupd_vecs; eauto.
Qed.
...
Proof.
(* original proof tokens: 17 *)
split; intros; simpl in *; split; auto; try lia; intros; subst; auto.
apply equal_unless_in_length_eq in H.
(* No more tactics to try *)
Admitted.
...
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; intros.
eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros.
eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros.
...
eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros.
eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros; eapply pimpl_exists_l; clear; intros.
...
eapply start_normalizing_right.
eapply start_normalizing_right; [ | | ].
eapply start_normalizing_right; [ | | ].
eapply start_normalizing_right; [ | | ].
